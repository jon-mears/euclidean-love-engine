...
Uniform::Uniform(const std::string& name, Uniform::Type eType, Uniform::Purpose ePurpose, GLuint loc) : mName{ name }, meType{ eType }, mePurpose{ ePurpose }, mLoc{ loc } { }
...
// static
Uniform* Uniform::Create(const std::string& rcName,
	Type eType, Purpose
	ePurpose, GLuint loc) {

	switch (eType) {
	case MAT4:
		return new UniformMat4(rcName, loc, ePurpose);
	case VEC4:
		return new Uniform4f(rcName, loc, ePurpose);
	case SAMPLER2D:
		return new UniformTexture2D(rcName, loc, ePurpose);
	default:
		std::cerr << "not yet implemented this uniform type!!!" << std::endl;
		std::exit(-1);
	}
}
...
// static
Uniform* Uniform::Create(const std::string& rcName,
	const std::string& rcType, Purpose ePurpose, GLuint loc) {
	if (rcType == "mat4") {
		return new UniformMat4(rcName, loc, ePurpose);
	}
...
Uniform1f::Uniform1f(const std::string& name, GLuint loc, Uniform::Purpose ePurpose) : Uniform{ name, FLOAT, ePurpose, loc}, mValue{} { }
...
Uniform2f::Uniform2f(const std::string& name, GLuint loc, Uniform::Purpose ePurpose) : Uniform{ name, VEC2, ePurpose, loc }, mValue{} { }
...
Uniform3f::Uniform3f(const std::string& name, GLuint loc, Uniform::Purpose ePurpose) : Uniform{ name, VEC3, ePurpose, loc }, mValue{} { }
...
Uniform4f::Uniform4f(const std::string& name, GLuint loc, Uniform::Purpose ePurpose) : Uniform{ name, VEC4, ePurpose, loc }, mValue{} { }
...
Uniform1i::Uniform1i(const std::string& name, GLuint loc, Uniform::Purpose ePurpose) : Uniform{ name, INT, ePurpose, loc }, mValue{} { }
...
Uniform2i::Uniform2i(const std::string& name, GLuint loc, Uniform::Purpose ePurpose) : Uniform{ name, IVEC2, ePurpose, loc }, mValue{} { }
...
Uniform3i::Uniform3i(const std::string& name, GLuint loc, Uniform::Purpose ePurpose) : Uniform{ name, IVEC3, ePurpose, loc }, mValue{} { }
...
Uniform4i::Uniform4i(const std::string& name, GLuint loc, Uniform::Purpose ePurpose) : Uniform{ name, IVEC4, ePurpose, loc }, mValue{} { }
...
UniformMat2::UniformMat2(const std::string& name, GLuint loc, Uniform::Purpose ePurpose) : Uniform{ name, MAT2, ePurpose, loc }, mValue{} { }
...
UniformMat3::UniformMat3(const std::string& name, GLuint loc, Uniform::Purpose ePurpose) : Uniform{ name, MAT3, ePurpose, loc }, mValue{} { }
...
UniformMat4::UniformMat4(const std::string& name, GLuint loc, Uniform::Purpose ePurpose) : Uniform{ name, MAT4, ePurpose, loc } { }
...
UniformTexture2D::UniformTexture2D(const std::string& name, GLuint loc, Uniform::Purpose ePurpose) : Uniform{ name, SAMPLER2D, ePurpose, loc }, mpValue{} { }
