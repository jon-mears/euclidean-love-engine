...
public:
	...
	Purpose mePurpose;
	Type meType;
	Uniform(const std::string& name, Type eType, Purpose ePurpose, GLuint loc);
	...
	static Uniform* Create(const std::string& rcName,
		Type eType, Purpose ePurpose, GLuint loc);
	...
	inline Type GetType() { return meType; }
...
public:
	...
	inline float Get() { return mValue; }
...
public:
	...
	inline glm::vec2 Get() { return mValue; }
	virtual void Upload() override;
};
...
public:
	...
	inline glm::vec3 Get() { return mValue; }
	virtual void Upload() override;
};
...
public:
	...
	inline glm::vec4 Get() { return mValue; }
	virtual void Upload() override;
};
...
public:
	...
	inline glm::ivec2 Get() { return mValue; }
	virtual void Upload() override;
};
...
public:
	...
	inline glm::ivec3 Get() { return mValue; }
	virtual void Upload() override;
};
...
public:
	...
	inline glm::ivec4 Get() { return mValue; }
	virtual void Upload() override;
};
...
public:
	...
	inline glm::mat2 Get() { return mValue; }
	virtual void Upload() override;
};
...
public:
	...
	inline glm::mat3 Get() { return mValue; }
	virtual void Upload() override;
};
...
public:
	...
	inline glm::mat4 Get() { return mValue; }
	virtual void Upload() override;
};
...
public:
	...
	inline Texture2D* Get() { return mpValue; }
	virtual void Upload() override;
};
#endif
